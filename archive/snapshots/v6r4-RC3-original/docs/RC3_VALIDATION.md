...
- Rebuild from `src/v6r4-RC3`: 7/7 generated installers byte-match repository-root production installers.
...
These gates qualify v6r4-RC3 for real Linux server UAT. They do not constitute GA approval.
