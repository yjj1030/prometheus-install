...
- Legacy cAdvisor/vmalert/vmauth installer sources are not part of RC4; historical delivery material is retained under repository `archive/` for traceability.
