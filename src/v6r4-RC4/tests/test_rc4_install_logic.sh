...
if grep -q 'DEFAULT_VERSION="1.151.0"' "${VM}"; then ok "VictoriaMetrics security baseline is 1.151.0"; else bad "VictoriaMetrics default version is below RC4 security baseline"; fi
